...
// Atrisa: GitHub Copilot stripped — prepareCopilotRipgrepShimTask removed
// (it materialized a ripgrep shim into the built-in copilot extension, which no
// longer ships). prepareBuiltInCopilotRipgrepShim import dropped accordingly.
